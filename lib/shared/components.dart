...
Widget? piece({
  ...
  if(point.x==cubit.from.x&&point.y==cubit.from.y&&point.z==cubit.from.z){
            ...
            child: Row(
              ...
              children: [
                Container(
                    ...
                    child: square(context:context,point: MyPoint(x: 1,z: 0))
                ),
                Container(
                    decoration: BoxDecoration(
                    border: Border.all(
                    ...
                    child: square(context:context,point: MyPoint(x: 1,z: 1))
                ),
                Container(
                    decoration: BoxDecoration(
                    border: Border.all(
                    ...
                    child: square(context:context,point: MyPoint(x: 1,z: 2))
                ),
              ],
            ),
          ),
            ...
            child: Row(
              ...
              children: [
                Container(
                    ...
                    child: square(context:context,point: MyPoint(x: 2,z: 0))
                ),
                Container(
                    decoration: BoxDecoration(
                        border: Border.all(
                    ...
                    child: square(context:context,point: MyPoint(x: 2,z: 1))
                ),
                Container(
                    decoration: BoxDecoration(
                        border: Border.all(
                    ...
                    child: square(context:context,point: MyPoint(x: 2,z: 2))
                ),
              ],
            ),
          ),
